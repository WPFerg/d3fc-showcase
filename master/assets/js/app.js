  ...
  */
  ...
  function initialiseModel() {
      ...
      function initSeriesSelector() {
          ...
          var candlestickOption = model$1.menu.option('Candlestick', 'candlestick',
          ...
          var options = [
              candlestickOption,
              model$1.menu.option('OHLC', 'ohlc', ohlc, 'sc-icon-ohlc-series'),
              model$1.menu.option('Line', 'line', line, 'sc-icon-line-series'),
              model$1.menu.option('Point', 'point', point, 'sc-icon-point-series'),
              model$1.menu.option('Area', 'area', area, 'sc-icon-area-series')
          ];
      ...
      function initIndicatorOptions() {
          ...
          var indicators = [
              model$1.menu.option('Moving Average', 'movingAverage',
                  movingAverage, 'sc-icon-moving-average-indicator', true),
              model$1.menu.option('Bollinger Bands', 'bollinger',
